...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&pause=1200&color=FFB03A&center=true&vCenter=true&width=520&height=42&lines=Spring+Boot+%2B+Django+%2B+React;From+the+API+to+the+pixel;Backend+that+holds%2C+frontend+that+feels" alt="" />
...
&nbsp;
[![Work profile](https://img.shields.io/badge/@AdalbertoCerrillo-0B1416?style=for-the-badge&logo=github&logoColor=F2EBDD)](https://github.com/AdalbertoCerrillo)
...
![Testing](https://img.shields.io/badge/Unit_·_Doctest_·_E2E-1A2A2D?style=for-the-badge&logo=pytest&logoColor=A78BFA)
...
```mermaid
graph LR
  A[Spring Boot / Django] -->|REST API| B[React]
  A --> C[(Database)]
  A --> D[Docker]
  B --> D
  D --> E[Production]
